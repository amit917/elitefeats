 ...
 * @var \App\Model\Entity\PendingAssessment[]|\Cake\Collection\CollectionInterface $pendingAssessment
 */
?>
...
<div class="pendingAssessment index large-9 medium-8 columns content">
    <h3><?= __('Pending Assessment') ?></h3>
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            <?php foreach ($pendingAssessment as $pendingAssessment): ?>
            <tr>
